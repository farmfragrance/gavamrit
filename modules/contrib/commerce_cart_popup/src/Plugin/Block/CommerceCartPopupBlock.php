...
namespace Drupal\commerce_cart_popup\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "commerce_cart_pop",
 *   admin_label = @Translation("Shopping Cart Popup"),
 *   category = @Translation("Commerce")
 * )
 */
class CommerceCartPopupBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    return [
      '#attached' => [
        'library' => ['commerce_cart_popup/commerce_cart_popup_block'],
      ],
      '#theme' => 'commerce_cart_popup_block',
      '#count' => $count,
